...
static const uint8_t DAC3100_CLK_PLL4 = 0x08;      // Register 8  - Clock Setting Register 5, D-Value LSB
...
static const uint8_t DAC3100_CLK_OUT_MUX = 0x1A;   // Register 26 - Clock Output M Divider Value
