...
SdMmcCreateDirectoryAction = sd_mmc_ns.class_(
    "SdMmcCreateDirectoryAction", automation.Action
)
SdMmcRemoveDirectoryAction = sd_mmc_ns.class_(
    "SdMmcRemoveDirectoryAction", automation.Action
)
